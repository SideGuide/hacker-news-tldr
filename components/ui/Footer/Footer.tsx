        ...
        <footer className="text-black bg-white body-font tails-selected-element" >
            <div className="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
                ...
                <span className="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
                    ...
                    <a href="https://instagram.com/sideguide.dev" className="text-gray-700 hover:text-gray-900">
                    ...
                    <a href="https://twitter.com/sideguide_dev" className="text-gray-700 hover:text-gray-900">
                    ...
                    <a href="https://github.com/sideguide" className="text-gray-700 hover:text-gray-900">
